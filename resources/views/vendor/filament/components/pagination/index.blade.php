        ...
        <span class="fi-pagination-overview">
            {{
                trans_choice(
                    ...
                    $paginator->total(),
                    [
                        'first' => \App\Support\SickasFormatter::number($paginator->firstItem() ?? 0),
                        'last' => \App\Support\SickasFormatter::number($paginator->lastItem() ?? 0),
                        'total' => \App\Support\SickasFormatter::number($paginator->total()),
                    ],
                )
            }}
        </span>
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        <x-filament::pagination.item
                            ...
                            :aria-label="trans_choice('filament::components/pagination.actions.go_to_page.label', $page, ['page' => \App\Support\SickasFormatter::number($page)])"
                            :label="\App\Support\SickasFormatter::number($page)"
